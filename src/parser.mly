...
Exp:
  ...
  | Exp DIVIDE Exp { S.Syntax.DIVIDE ($1,$3, $2) }
  | Exp MOD Exp { S.Syntax.MOD ($1,$3, $2) }
  | MINUS Exp %prec UMINUS { S.Syntax.UMINUS ($2, $1) }
  ...
  | LARGEST Exp Exp { S.Syntax.LARGEST ($2,$3, $1) }
...
ExpList1:
    Exp  { $1 }
  | Exp COMMA ExpList1 { S.Syntax.CONC ($1,$3, $2) }
;

ExpList2:
    Exp  { [$1] }
  | Exp COMMA ExpList2 { $1 :: $3 }
;
